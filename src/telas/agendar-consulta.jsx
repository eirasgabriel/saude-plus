...
// Horários e confirmação via ../logica-de-controle/agenda (API / mock em desenvolvimento)
...
import {
  ...
  criarAgendamento,
} from "../logica-de-controle/agenda";
...
function AgendarConsulta() {
  ...
  const clinica = useMemo(
    () => (clinicaIdParam ? buscarClinicaPorId(clinicaIdParam) : null),
    [clinicaIdParam]
  );
